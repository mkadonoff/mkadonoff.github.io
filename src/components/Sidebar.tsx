...
export function Sidebar({ conversations, activeId, onSelect, onNew, onDelete, open }: Props) {
  return (
    <aside
      className={`${
        open ? 'w-72' : 'w-0'
      } shrink-0 overflow-hidden border-r border-white/10 bg-neutral-950 transition-[width] duration-200`}
    >
